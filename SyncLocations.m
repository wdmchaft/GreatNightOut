...
-(int) sync {
    ...
    // Get your array of objects with status L and fill in any missing data 
    NSArray *fetchedLocations = [[NSArray alloc]initWithArray:[self getStatusL]];
    if (fetchedLocations != nil)
    {
        // Create your array of new items
    ...
    // Now update the objects in the fetched data with the updated data
